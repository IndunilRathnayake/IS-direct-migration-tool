...
public class SP510DataRetrieval {

    private static Logger logger = LoggerFactory.getLogger(SP510DataRetrieval.class);

    private static SP510DataRetrieval sp510DataRetrieval;
    ...
    private SP510DataRetrieval() {

    }

    private SP510DataRetrieval(String hostname, String port, String trustStorePath, String trustStorePassword,
    ...
    public static SP510DataRetrieval getInstance(String hostname, String port, String trustStorePath,
                                                 String trustStorePassword, String adminUsername,
                                                 String adminPassword) {
        if (sp510DataRetrieval == null) {
            synchronized (SP510DataRetrieval.class) {
                if (sp510DataRetrieval == null) {
                    sp510DataRetrieval = new SP510DataRetrieval(hostname, port, trustStorePath, trustStorePassword,
                            adminUsername, adminPassword);
                }
            }
        }
        return sp510DataRetrieval;
    }
